...
dotenv.load_dotenv()
gic = SpatialPointReasoner(gemini_api_key=os.getenv("GEMINI_API_KEY"), model="gemini-3-pro-preview")
...
def _collect_image_files(input_dir: Path = CHALLENGE_VIEW_DIR) -> list[Path]:
    ...
    if IS_COLLECT_SELECT_FILE:
        return [
            input_dir.joinpath("20251119221336842390_0_challenge_view.png"),
            input_dir.joinpath("20251120030936487029_0_challenge_view.png"),
        ]
